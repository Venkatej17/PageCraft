...
everything else exactly as it was. Return ONLY the complete, updated raw HTML, starting with <!DOCTYPE html>
and ending with </html>. No markdown code fences, no explanation, no commentary before or after."""
